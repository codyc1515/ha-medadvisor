"""Adds config flow for MedAdvisor."""
...
from .api import (
    ...
    MaApiCommunicationError,
    MaApiError,
)
from .const import DOMAIN, LOGGER


class MaFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Config flow for MedAdvisor."""
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            ...
            except MaApiCommunicationError as exception:
